...
class Game {
    constructor() {
        ...
        // Initialize high score from localStorage or set to 0 if not exists
        this.highScore = parseInt(localStorage.getItem('towerBlockHighScore')) || 0;
        
        // Create high score display element
        this.highScoreContainer = document.createElement('div');
        this.highScoreContainer.id = 'high-score';
    ...
    updateHighScore(score) {
        if (score > this.highScore) {
            ...
            localStorage.setItem('towerBlockHighScore', this.highScore);
            this.highScoreContainer.innerHTML = 'High Score: ' + this.highScore;
        }
    }
